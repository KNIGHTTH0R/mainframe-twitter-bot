...
class TwitterController extends ApiController
{
    ...
    public function requestToken(Request $request)
    {
        if($request->has("denied")){
            return redirect("https://mainframe.com/bots/auth/?state=cancel&name=Twitter%20Bot&logo_url=".env('TWITTER_URL_ICON'));
        }
        ...
        if(!$user){
            return redirect("https://mainframe.com/bots/auth/?state=error&name=Twitter%20Bot&logo_url=".env('TWITTER_URL_ICON'));
        }
        ...
        return redirect("https://mainframe.com/bots/auth/?state=success&name=Twitter%20Bot&logo_url=".env('TWITTER_URL_ICON'));
    }
